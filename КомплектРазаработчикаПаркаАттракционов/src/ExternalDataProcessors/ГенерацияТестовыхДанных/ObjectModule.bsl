...
// Заполняет бд случайными данными о посещениях
Процедура СгенерироватьДанные() Экспорт
	...
	// Выбираем случайныых посетителей изсписка
...
Процедура СформироватьПосещенияПосетителя(Посетитель, ДатаПосещения, СписокАттракционов, ГСЧ = Неопределено);
	...
	// Для каждого посетителя выыбираем, на сколько аттракционов он пойдет
	// Проверяем для каждого посещения, есть ли билет, если билета нет - покупаем доступныый для нужного аттракциона
